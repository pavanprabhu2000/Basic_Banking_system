...
<head>
  ...
  <div class="w3-container w3-center  w3-panel">
    <h1 style=" font-family:Monospace; font-size: 80px; color:#ADFF2F;text-shadow: 2px 2px black;"> THUNDER BANK </h1>
  </div>
</head>
  ...
  <div class="box">
    <div class="w3-bar w3-blue w3-large">
      <ul>
        ...
        <li><a class="w3-bar-item w3-button" href="transfer.php">all transaction</a></li>
      </ul>
    </div>
    <div class="w3-main">
      <h1>Users</h1>
